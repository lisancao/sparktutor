...
Refactor the order filtering pipeline to use only DataFrame API.
...
def filter_orders_by_status(spark, status: str):
    ...
    # TODO: Create DataFrame from ORDERS_DATA and ORDERS_COLUMNS
    # Use spark.createDataFrame — NOT sparkContext.parallelize

    # TODO: Filter by status column using .filter() or .where()
