"""
Bronze — Multi-Source Ingestion (Starter)

Implement bronze_clicks, bronze_payments, bronze_inventory for ShopStream.
Use a shared SCHEMAS dict. All add metadata and deduplicate.
"""
...
def bronze_clicks(spark, csv_path):
    ...
    # TODO: Use SCHEMAS["clicks"], read CSV, add metadata, dedup by event_id
    pass


def bronze_payments(spark, json_path):
    """Ingest raw payment events."""
    # TODO: Use SCHEMAS["payments"], read JSON, add metadata, dedup by payment_id
    pass


def bronze_inventory(spark, json_path):
    """Ingest raw inventory updates."""
    # TODO: Use SCHEMAS["inventory"], read JSON, add metadata, dedup by (sku, warehouse_id)
    pass
