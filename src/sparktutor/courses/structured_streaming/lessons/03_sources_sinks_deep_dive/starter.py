"""
Sources & Sinks Deep Dive — Starter Code

Process transactions and route alerts to multiple destinations.
Filter high-amount transactions (> 500), add alert_type, return for
both console and file sink simulation.
"""
...
def process_and_route_alerts(spark, transactions_df):
    ...
    Return (alerts_df, alerts_df) for console and file sink simulation."""
    return (None, None)
